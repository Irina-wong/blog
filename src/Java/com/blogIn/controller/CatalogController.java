...
import com.blogIn.doa.Catalog;
import com.blogIn.doa.User;
import com.blogIn.service.CatalogService;
import com.blogIn.util.ConstraintViolationExceptionHandler;
import com.blogIn.vo.CatalogVO;
...
public class CatalogController {
	...
	@PostMapping
	@PreAuthorize("authentication.name.equals(#catalogVO.username)") // Authorization
	...
	// Get the edit page according to the id of user
	@GetMapping("/edit/{id}")
